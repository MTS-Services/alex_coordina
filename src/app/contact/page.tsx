  ...
  return (
    <div className="max-w-7xl mx-auto grid md:grid-cols-2 grid-cols-1 md:gap-10 gap-6 items-center h-screen md:my-0 mt-[100px] md:mb-0 mb-[200px] px-4 sm:px-6 lg:px-14">
      <div className="col-span-1 w-full md:mb-36">
        ...
        <h3 className="text-[#222222] text-[22px] font-semibold md:my-10 my-4">
          Contacts
        </h3>
        <div className="flex flex-col items-start md:gap-6 gap-3 md:my-5 my-3">
          <a
        ...
        <div className="flex items-center md:gap-10 gap-6 md:mt-10 mt-6 text-[#555555]">
          <a
            href="#"
            aria-label="LinkedIn"
